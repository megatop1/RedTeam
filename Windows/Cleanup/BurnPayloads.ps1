# The following script will remove all of the payloads on the system in case the system is being investigated by blue team and we need to cover our tracks
...
del C:\Windows\Globalization\ELS\LogMGMT.exe
del C:\Windows\System32\sysinit.dll
